...
#ifndef SUBSCRIBERIFACE_P_H_1230569631
#define SUBSCRIBERIFACE_P_H_1230569631
...
public Q_SLOTS: // METHODS
    inline QDBusReply<ValueSetMap> Subscribe(const QStringList &keys, QStringList &undeterminable_keys)
    {
...
Q_SIGNALS: // SIGNALS
    void Changed(ValueSetMap values, const QStringList &undeterminable_keys);
};
