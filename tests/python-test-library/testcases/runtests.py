...
if __name__ == "__main__":
    ...
    #Library test cases
    print "Running library test cases"
    libraryTestProcess = Popen("libtool --mode=execute -dlopen libcontextprovider.la python tests/python-test-library/testcases/testlibcontextprovider.py", shell=True)
    os.waitpid(libraryTestProcess.pid, 0)
